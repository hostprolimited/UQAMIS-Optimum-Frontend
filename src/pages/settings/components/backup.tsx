...
//         }
//         // Map subcounty_id to subcounty and ward_id to ward
//         if (updateData.subcounty_id) {
//           updateData.subcounty = updateData.subcounty_id;
//           delete updateData.subcounty_id;
//         }
//         if (updateData.ward_id) {
//           updateData.ward = updateData.ward_id;
...
//           createData.subcounty = createData.subcounty_id;
//           delete createData.subcounty_id;
//         }
//         if (createData.ward_id) {
//           createData.ward = createData.ward_id;
