  ...
  return (
    <div className="space-y-8" role="main">
      ...
      <header className="flex items-start justify-between gap-6">
        <div>
          <h1 className="text-3xl md:text-4xl font-bold">Safety Assessments</h1>
          <p className="text-muted-foreground mt-2 max-w-2xl">
            Monitor facility safety assessments across institutions within the county. Use the filters to focus on specific
