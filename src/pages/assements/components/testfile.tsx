            ...
            <Form {...facilityForm}>
              <form onSubmit={facilityForm.handleSubmit(handleFacilityAssessmentSubmit)}>
                <Tabs defaultValue="maintenance" className="space-y-4">
                  <TabsList>
                    <TabsTrigger value="maintenance" disabled={hasToiletFacility === false}>Maintenance</TabsTrigger>
                    <TabsTrigger value="safety" disabled={hasToiletFacility === false}>Safety</TabsTrigger>
                  </TabsList>
                                      ...
                                      <FormItem className="flex justify-center">
                                        <FormControl>
                                          <input
                                            type="radio"
                                            value={condition}
                                            disabled={hasToiletFacility === false}
                                            ...
                                            } ${hasToiletFacility === false ? 'opacity-50 cursor-not-allowed' : ''}`}
                                            style={
                  ...
                  <TabsContent value="safety">
                    <div className={hasToiletFacility === false ? 'opacity-50 pointer-events-none' : ''}>
                ...
                {/* File Upload Section */}
                <div className={`space-y-4 ${hasToiletFacility === false ? 'opacity-50 pointer-events-none' : ''}`}>
                  <FormField
                    control={facilityForm.control}
                    name="files"
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="space-y-4">
                            {/* File Upload Area */}
                            <div
                              onDragOver={hasToiletFacility === false ? undefined : handleDragOver}
                              onDrop={hasToiletFacility === false ? undefined : handleDrop}
                              className={`border-2 border-dashed border-gray-300 rounded-lg p-6 text-center transition-colors ${hasToiletFacility === false ? 'cursor-not-allowed' : 'hover:border-gray-400 cursor-pointer'}`}
                              onClick={hasToiletFacility === false ? undefined : () => fileInputRef.current?.click()}
                            >
                                  ...
                                  {uploadedFiles.map((file, index) => (
                                    <div key={index} className="flex items-center justify-between bg-gray-50 p-3 rounded-md">
                                      ...
                                      <Button
                                        ...
                                        variant="ghost"
                                        size="sm"
                                        onClick={hasToiletFacility === false ? undefined : () => removeFile(index)}
                                        disabled={hasToiletFacility === false}
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            ...
                            className={`min-h-[120px] resize-none ${hasToiletFacility === false ? 'cursor-not-allowed' : ''}`}
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
